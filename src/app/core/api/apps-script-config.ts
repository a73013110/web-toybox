 ...
 *
 * ⚠️ scripts/gs-deploy.mjs 會用 regex 從這個檔案抓出部署 ID，
 *    改動這一行的格式時要一併確認那支腳本還讀得到。
 *
 * 部署與遷移步驟見 apps-script/README.md。
 */
export const APPS_SCRIPT_ENDPOINT =
  'https://script.google.com/macros/s/AKfycby-Do-rPfjTh9s45SBwuAY0H55DpOI6hoVPo8QPghnk45b1xtN_CtpYYUHUeWmmwCWKFg/exec';

/** 送出請求的預設逾時。Apps Script 冷啟動可能要數秒，不要設太短。 */
export const APPS_SCRIPT_TIMEOUT_MS = 30_000;
